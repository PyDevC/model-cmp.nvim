...
local function get_ctx_location()
...
local function get_ctx()
  ...
  if #ctx_location == 2 then
    text = vim.api.nvim_buf_get_lines(ctx_mangaer.bufnr, ctx_location[1] - 1, ctx_location[1], false)
  elseif #ctx_location == 4 then
    text = vim.api.nvim_buf_get_lines(ctx_mangaer.bufnr, ctx_location[1] - 1, ctx_location[3], false)
  end
  return text
end
